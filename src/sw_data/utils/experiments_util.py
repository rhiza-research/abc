...
def get_us_mask(filename="data/masks/us_mask.nc"):
...
def get_id_name(gt_id, None_ok=False):
    if gt_id in ["tmp2m", "temp", "contest_tmp2m", "contest_temp"]:
        ...
        return "us_precip"
    elif gt_id in ["era5_global_tmp2m_1.5x1.5", "era5_global_temp_1.5x1.5"]:
        return "era5_global_tmp2m_1.5x1.5"
    elif gt_id in ["era5_global_prate_1.5x1.5", "era5_global_precip_1.5x1.5"]:
        return "era5_global_precip_1.5x1.5"
